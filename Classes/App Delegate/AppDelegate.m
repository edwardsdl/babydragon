...
@synthesize window=window_, navController=_navController, director=director_;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	_navController = [[MyNavigationController alloc] initWithRootViewController:director_];
	_navController.navigationBarHidden = YES;

	// for rotation and other messages
	[director_ setDelegate:_navController];
	
	// set the Navigation Controller as the root view controller
	[window_ setRootViewController:_navController];
